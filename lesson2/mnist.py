...
class CNN_NET(paddle.nn.Layer):
    def __init__(self):
        ...
        self.conv1 = Conv2D(in_channels=1, out_channels=1, kernel_size=2, stride=1, padding=0)
...
def print_net_summery():
    model = CNN_NET()
    params_info = paddle.summary(model, (1, 1, 4, 4))
    print(model.conv1)
    print(params_info)
...
if __name__ == '__main__':
    ...
    array_1 = np.random.randint(2, size=[1, 1, 4, 4])
    print(array_1)
